...
public class Run {
     ...
     */
    public static void printSimpleDetectionStatsTimestamped(BrightBodyList[] mobile_bodies, BrightBodyList[] immobile_bodies, BrightBodyList[] noise, int timestamp) {
     ...
     * @param timestamp the timestamp of which to output the data
     */
    public static void printSimpleDetectionDataTimestamped(BrightBodyList[] mobile_bodies, BrightBodyList[] immobile_bodies, BrightBodyList[] noise_bodies, int timestamp) {
        System.out.println();
